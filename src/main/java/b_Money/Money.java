...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		int amount2 = this.getAmount() + other.getCurrency().valueInThisCurrency(other.getAmount(), this.getCurrency());
		return new Money(amount2, this.getCurrency());
	}
